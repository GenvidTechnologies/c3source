# 0019. Materialize the canonical fixture from the submodule's tracked HEAD content, not its working tree
...
0013](0013-fflate-dependency-c3addon-reader.md) — no new dependency), writing each entry byte-for-byte, never
...
submodule) — so the change moves no [ADR 0016](0016-c3-source-json-serialization-form.md) round-trip claim —
...
0018](0018-brush-json-minified-source-not-editor-local.md)'s trap is unchanged by this decision:
