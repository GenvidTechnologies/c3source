...
title: "ADR 0015 — Adopt construct3-sample as the canonical C3 reference fixture; c3source validates, it does not own"
description: A standalone repo, construct3-sample, becomes the single canonical, editor-round-tripped golden C3 project consumed as a tag-pinned git submodule; c3source ships the validators (validateForEditor, detectManifestDrift) but is a peer consumer, not the owner.
tags: [adr, fixtures, submodules, testing]
status: stable
generated: { by: process:maintain-wiki, at: 2026-08-20T15:48:57Z }
sources:
  - id: adr-0015
    resource: ../../raw/adr-0015-canonical-c3-reference-fixture-2026-08-20.md
    title: "ADR 0015 (docs/decisions capture, 2026-08-20)"
    last_modified: 2026-08-20
---

# ADR 0015 — Adopt construct3-sample as the canonical C3 reference fixture; c3source validates, it does not own

**Status:** accepted (complements [ADR 0013](/decisions/0013-fflate-dependency-c3addon-reader.md) / [ADR 0014](/decisions/0014-sdk-submodule-recursive-ci-checkout.md))
**Date:** 2026-07-22
**Issue:** #51 (also references #44, #50)

Migrated verbatim from the `docs/decisions/` ADR record[^adr-0015].
...
- [ADR 0013 — Depend on fflate for .c3addon zip reading](/decisions/0013-fflate-dependency-c3addon-reader.md) — the sibling fixture dependency (the Scirra SDK) this decision leaves untouched.
- [ADR 0014 — SDK submodule read-only, recursive CI checkout](/decisions/0014-sdk-submodule-recursive-ci-checkout.md) — the immediately preceding decision this one complements.
- [ADR 0019 — Hermetic fixture materialization](/decisions/0019-hermetic-fixture-materialization.md) — later hardens `scripts/prep-fixture.mjs`'s materialization step this ADR establishes.
- [ADR 0026 — Fixture gate skip-vs-throw and forbid-pending](/decisions/0026-fixture-gate-skip-vs-throw-and-forbid-pending.md) — later closes a gap in how tests degrade against this fixture.
- [Canonical Reference Fixture](/canonical-fixture.md) — the current state of the fixture this ADR establishes ownership for.

[^adr-0015]: ADR 0015 (docs/decisions capture, 2026-08-20)
