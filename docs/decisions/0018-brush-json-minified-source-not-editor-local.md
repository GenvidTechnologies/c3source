# 0018. `*.brush.json` is minified project source, not editor-local
...
[0016](0016-c3-source-json-serialization-form.md), corrected corpus: 29 total,
3 editor-local, 26 source, 25 of those round-trip). #59 asked whether the fix is
to widen `EDITOR_LOCAL_EXCLUSIONS` (the ADR [0006](0006-editor-local-classifier.md)
